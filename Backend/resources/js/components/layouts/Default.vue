            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <router-link :to="{name:'ambientes'}" class="nav-link">Lista <span class="sr-only">(ambientes)</span></router-link>
                        </li>
                        <li class="nav-item">
                            <router-link :to="{name:'facultadOficina'}" class="nav-link">Lista <span class="sr-only">(Oficina)</span></router-link>
                        </li>
